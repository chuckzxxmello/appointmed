# UI/UX & Accessibility Testing Guide
...
### A. Mobile Viewport
Ensure the layout adapts gracefully to screens ~390px wide.
* **Steps:**
...
### B. Tablet Viewport
Ensure optimal spacing and typography on medium screens (~768px - 1024px).
* **Steps:**
...
Verify interactive elements provide immediate visual feedback.
* **Steps:**
...
Ensure modals and drag drop zones open and close smoothly.
* **Steps:**
...
Verify that core workflows can be completed without a mouse.
* **Steps:**
