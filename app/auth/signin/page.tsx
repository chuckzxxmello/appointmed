    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-gray-600">Sign in to your AppointMED account</p>
        </div>
        ...
        <Card className="shadow-xl border-0 animate-scale-in">
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-blue-900 hover:bg-blue-800 text-white transition-all duration-300 hover-lift"
                disabled={loading}
              >
                {loading ? (
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/auth/signup" className="text-blue-900 hover:text-blue-700 font-medium transition-colors">
                Sign up
              </Link>
            </div>
          </CardContent>
